...
st.set_page_config(page_title="Dashboard — Adaptive Learning", page_icon="🎓", layout="wide")
...
st.markdown(f"Welcome back, **{username}**! Here are your courses.")
st.markdown("---")
...
with st.expander("➕ Create New Course", expanded=False):
    ...
    if submitted:
        if not course_name.strip():
            ...
            # Clear any leftover learning state
...
if not courses:
    st.info("You have no courses yet. Create one above to get started.")
else:
