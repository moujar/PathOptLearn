...
from db import login_student, register_student, verify_student, resend_verification, get_student_by_username
from mailer import send_verification_email

st.set_page_config(page_title="Login — PathOptLearn", page_icon="🎓", layout="centered")
...
with col_c:
    ...
    st.markdown("##### Personalised adaptive learning powered by AI")
    st.markdown("---")
        ...
        if submitted:
            if not username or not password:
                ...
                if ok:
                    ...
                    row = get_student_by_username(username.strip())
                    if row:
                        sid, email = row
